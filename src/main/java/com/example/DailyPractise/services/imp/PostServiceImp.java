...
public class PostServiceImp implements PostService {
    ...
    public PostDto updatePost(Long id, Map<String, Object> data) {
        ...
        data.forEach((key,value) -> {
            Field toBeSavedField = ReflectionUtils.findRequiredField(PostEntity.class,key);
            toBeSavedField.setAccessible(true);
            ReflectionUtils.setField(toBeSavedField,postEntity,value);
        });
