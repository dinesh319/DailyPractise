...
public class UserService implements UserDetailsService {
    ...
    public UserEntity findUserById(Long id){
        UserEntity user = userRepository.findById(id).orElseThrow(() -> new BadCredentialsException("user with id "+id+" does not exists"));
        return user;
    }
    ...
    public UserEntity saveUser(UserEntity signUpData){
        return  userRepository.save(signUpData);
    }
}
